...
for line in hand:
    ...
    num_counts_e = len(re.findall(r'Esther', line))#your code here - use regex and figure out how many times 'Esther' is found in the line
    num_counts_g = len(re.findall(r'Guppy', line))
...
plt.plot(chapter_list, counts_esther, counts_guppy)

plt.xlabel('Chapter')
plt.ylabel('Mentions')
plt.title('Chapter appearaence in Bleak House')
plt.show()
